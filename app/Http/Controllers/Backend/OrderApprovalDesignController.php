...
class OrderApprovalDesignController extends Controller
{
    public function store(Request $request)
    {
        $validated = Validator::make(
            $request->all(),
            [
                'fifty_percent_payment' => 'required|image|mimes:jpg,png,jpeg,webp,svg|file|max:5120',
            ],
            [
                'fifty_percent_payment.required' => 'Silakan unggah gambar terlebih dahulu.',
