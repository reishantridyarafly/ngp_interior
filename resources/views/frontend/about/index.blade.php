                ...
                <div class="col-lg-8">
                    <div class="breadcrumb__wrapper">
                        ...
                        <ul class="breadcrumb__list">
                            ...
                            <li class="breadcrumb__item"> <span class="breadcrumb__item-text"> @yield('title') {{ config('app.name') }} </span>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="about-content">
                        <div class="section-heading style-left">
                            ...
                            <p class="section-heading__desc font-18">Real estate is a lucrative industry that involves
                                the buying selling and renting of properties. It encompasses residential commercial and
                        ...
                        <div class="about-button">
                            <a href="#" class="btn btn-outline-main bg-white">Learn More <span class="icon-right"> <i
                    ...
                    <div class="property-type-three-item d-flex align-items-start">
                        ...
                        <div class="property-type-three-item__content">
                            ...
                            <p class="property-type-three-item__desc font-18">Real estate is a lucrative ind involves
                                the buying selling and reproperties. It encompa </p>
        ...
        <div class="container container-two">
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-sm-6 col-xs-6">
                    <div class="team-item">
                        <div class="team-item__thumb">
                            <img src="{{ asset('frontend/assets') }}/images/thumbs/team1.png" alt=""
                                class="cover-img">
                        </div>
                        <div class="team-item__content flx-between flex-nowrap">
                            <div>
                                <h6 class="team-item__name mb-1 text-white">Annette Black</h6>
                                <span class="team-item__designation font-12 text-white fw-light">President of
                                    Sales</span>
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 col-xs-6">
                    <div class="team-item">
                        <div class="team-item__thumb">
                            <img src="{{ asset('frontend/assets') }}/images/thumbs/team2.png" alt=""
                                class="cover-img">
                        </div>
                        <div class="team-item__content flx-between flex-nowrap">
                            <div>
                ...
                <div class="col-lg-4 col-sm-6 col-xs-6">
                    <div class="team-item">
                        <div class="team-item__thumb">
                            <img src="{{ asset('frontend/assets') }}/images/thumbs/team3.png" alt=""
                                class="cover-img">
                        </div>
                        <div class="team-item__content flx-between flex-nowrap">
                            <div>
                                <h6 class="team-item__name mb-1 text-white">Bessie Cooper</h6>
                                <span class="team-item__designation font-12 text-white fw-light">Director of
                                    Sales</span>
                            </div>
                            <div class="social-share">
                                <button type="button" class="social-share__button"><i
