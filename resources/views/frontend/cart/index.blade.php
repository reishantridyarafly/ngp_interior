                            ...
                            <div class="card-body">
                                <table class="table style-two">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="cart-item__thumb">
                                                        <img src="{{ asset('frontend/assets') }}/images/thumbs/property-1.png" alt="">
                                                    </div>
                                                    <div class="cart-item__content">
                                                        ...
                                                        <p class="property-item__location d-flex gap-2 font-14">
                                                            <span class="icon text-gradient"> <i
                                                                    class="fas fa-map-marker-alt"></i></span> 66
                                                            Broklyant, New York America
                                                        </p>
                                                        <span class="cart-item__price">Price: <span
                                                                class="fw-500 text-heading">$85.00</span></span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="cart-item__count">
                                                    <button data-decrease="data-decrease"> <i
                                                            class="fas fa-minus"></i></button>
                                                    <input data-value="data-value" type="number" value="1">
                                                    <button data-increase="data-increase"><i
                                            ...
                                            <td>
                                                <button type="button"
                                                    class="rounded-btn delete-btn  text-danger bg-danger bg-opacity-10 flex-shrink-0"><i
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="cart-item__thumb">
                                                        <img src="{{ asset('frontend/assets') }}/images/thumbs/property-2.png" alt="">
                                                    </div>
                                                    <div class="cart-item__content">
                                                        <h6 class="cart-item__title fw-500 font-18"> <a href="property.html"
                                                                class="link">Wheel Bearing
                                                                Retainer</a></h6>
                                                        <p class="property-item__location d-flex gap-2 font-14">
                                                            <span class="icon text-gradient"> <i
                                                                    class="fas fa-map-marker-alt"></i></span> 66
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="cart-item__thumb">
                                                        <img src="{{ asset('frontend/assets') }}/images/thumbs/property-3.png" alt="">
                                                    </div>
                                                    <div class="cart-item__content">
                                                        <h6 class="cart-item__title fw-500 font-18"> <a href="property.html"
                                                                class="link">
                                                                Your journey home owner ship</a></h6>
                                                        <p class="property-item__location d-flex gap-2 font-14">
                                                            <span class="icon text-gradient"> <i
                                                                    class="fas fa-map-marker-alt"></i></span> 66
                                                            Broklyant, New York America
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-3">
                                                    ...
                                                    <div class="cart-item__content">
                                                        <h6 class="cart-item__title fw-500 font-18"> <a
                                                                href="property.html" class="link">3 Rooms
                                                                Manhattan</a></h6>
                                                        <p class="property-item__location d-flex gap-2 font-14">
                                                            <span class="icon text-gradient"> <i
                                                                    class="fas fa-map-marker-alt"></i></span> 66
                                ...
                                <div class="mt-5 d-flex align-items-center gap-4 justify-content-between">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <button type="button" class="btn btn-main flex-shrink-0"> Apply Coupon
                                        </button>
                                    </div>
                ...
                <div class="col-lg-4">
                    <div class="card common-card">
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-main w-100 mt-4">Proceed To Checkout</button>
                        </div>
                    </div>
                </div>
            </div>
