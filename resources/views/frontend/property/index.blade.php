                        ...
                        <div class="col-lg-2 col-md-3 col-sm-6 col-xs-6">
                            <div class="select-has-icon">
                                ...
                                <span class="input-icon input-icon--left text-gradient">
                                    <img src="{{ asset('frontend/assets') }}/images/icons/status.svg" alt="">
                                </span>
                            </div>
                        </div>
            ...
            <div class="list-grid-item-wrapper show-two-item row gy-4">
                    ...
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-7.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-8.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                            <h6 class="property-item__title">
                                <a href="property-details.html" class="link"> Your journey homeownership starts here
                                    too </a>
                            </h6>
                            <ul class="amenities-list flx-align">
                                <li class="amenities-list__item flx-align">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-9.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                            <h6 class="property-item__title">
                                <a href="property-details.html" class="link"> Brick by Brick Your Dream Home Awaits
                                </a>
                            </h6>
                            <ul class="amenities-list flx-align">
                                <li class="amenities-list__item flx-align">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-10.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                            <h6 class="property-item__title">
                                <a href="property-details.html" class="link"> Opening Doors to Your Dreams For
                                    Living </a>
                            </h6>
                            <ul class="amenities-list flx-align">
                                <li class="amenities-list__item flx-align">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-11.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-12.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                            <h6 class="property-item__title">
                                <a href="property-details.html" class="link"> Building Trust, One Home at a Time
                                </a>
                            </h6>
                            <ul class="amenities-list flx-align">
                                <li class="amenities-list__item flx-align">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-13.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-14.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                            <h6 class="property-item__title">
                                <a href="property-details.html" class="link"> A Tradition of Trust in Real Estate
                                </a>
                            </h6>
                            <ul class="amenities-list flx-align">
                                <li class="amenities-list__item flx-align">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-15.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-16.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-17.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="property-item style-two">
                        <div class="property-item__thumb">
                            <a href="property-details.html" class="link">
                                <img src="{{ asset('frontend/assets') }}/images/thumbs/property-18.png" alt=""
                                    class="cover-img">
                            </a>
                        </div>
                        <div class="property-item__content">
