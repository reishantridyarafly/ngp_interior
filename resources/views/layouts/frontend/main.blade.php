...
<head>
    ...
    <meta property="og:title" content="NGP Interior Design">
    <meta property="og:description" content="Professional Interior Design Services">
    <meta property="og:image" content="{{ asset('backend/assets') }}/images/logo_ngp_2.png">
    <meta property="og:url" content="http://ngpinteriorkuningan.servicesolutions.my.id/">
    <meta property="og:site_name" content="NGP Interior Design">
    <!-- Title -->
